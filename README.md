...
The purpose of this tiny project is to send emails from an application running in a container using existing email subscription, in my case this is Proton. This solved the following business requirements:
